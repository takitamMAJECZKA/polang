...
var _run_code = Module['_run_code'] = makeInvalidEarlyAccess('_run_code');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['run_code'] != 'undefined', 'missing Wasm export: run_code');
  ...
  _run_code = Module['_run_code'] = createExportWrapper('run_code', 1);
